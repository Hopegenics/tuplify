...
WORKDIR /src
COPY ["HG.Tuplify.CognitoTrigger.MerchantFunction.csproj", "HG.Tuplify.CognitoTrigger.MerchantFunction/"]
RUN dotnet restore "HG.Tuplify.CognitoTrigger.MerchantFunction/HG.Tuplify.CognitoTrigger.MerchantFunction.csproj"

WORKDIR "/src/HG.Tuplify.CognitoTrigger.MerchantFunction"
COPY . .
RUN dotnet build "HG.Tuplify.CognitoTrigger.MerchantFunction.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "HG.Tuplify.CognitoTrigger.MerchantFunction.csproj" \
...
Execute unit tests
```
cd "HG.Tuplify.CognitoTrigger.MerchantFunction/test/HG.Tuplify.CognitoTrigger.MerchantFunction.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "HG.Tuplify.CognitoTrigger.MerchantFunction/src/HG.Tuplify.CognitoTrigger.MerchantFunction"
