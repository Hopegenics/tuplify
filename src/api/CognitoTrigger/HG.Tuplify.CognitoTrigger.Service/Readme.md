...
WORKDIR /src
COPY ["HG.Tuplify.CognitoTrigger.Service.csproj", "HG.Tuplify.CognitoTrigger.Service/"]
RUN dotnet restore "HG.Tuplify.CognitoTrigger.Service/HG.Tuplify.CognitoTrigger.Service.csproj"

WORKDIR "/src/HG.Tuplify.CognitoTrigger.Service"
COPY . .
RUN dotnet build "HG.Tuplify.CognitoTrigger.Service.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "HG.Tuplify.CognitoTrigger.Service.csproj" \
...
Execute unit tests
```
cd "HG.Tuplify.CognitoTrigger.Service/test/HG.Tuplify.CognitoTrigger.Service.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "HG.Tuplify.CognitoTrigger.Service/src/HG.Tuplify.CognitoTrigger.Service"
