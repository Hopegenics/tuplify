...
WORKDIR /src
COPY ["HG.Tuplify.Customer.WebApi.csproj", "HG.Tuplify.Customer.WebApi/"]
RUN dotnet restore "HG.Tuplify.Customer.WebApi/HG.Tuplify.Customer.WebApi.csproj"

WORKDIR "/src/HG.Tuplify.Customer.WebApi"
COPY . .
RUN dotnet build "HG.Tuplify.Customer.WebApi.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "HG.Tuplify.Customer.WebApi.csproj" \
...
Execute unit tests
```
    cd "HG.Tuplify.Customer.WebApi/test/HG.Tuplify.Customer.WebApi.Tests"
    dotnet test
```

Deploy application
```
    cd "HG.Tuplify.Customer.WebApi/src/HG.Tuplify.Customer.WebApi"
