...
WORKDIR /src
COPY ["Hopegenics.Tuplify.WebApi.csproj", "Hopegenics.Tuplify.WebApi/"]
RUN dotnet restore "Hopegenics.Tuplify.WebApi/Hopegenics.Tuplify.WebApi.csproj"

WORKDIR "/src/Hopegenics.Tuplify.WebApi"
COPY . .
RUN dotnet build "Hopegenics.Tuplify.WebApi.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "Hopegenics.Tuplify.WebApi.csproj" \
...
Execute unit tests
```
    cd "Hopegenics.Tuplify.WebApi/test/Hopegenics.Tuplify.WebApi.Tests"
    dotnet test
```

Deploy application
```
    cd "Hopegenics.Tuplify.WebApi/src/Hopegenics.Tuplify.WebApi"
